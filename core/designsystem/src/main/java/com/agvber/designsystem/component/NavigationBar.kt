...
import com.agvber.designsystem.theme.Black90
    ...
    Surface(color = Black90) {
        Row(
            modifier = modifier
                ...
                .selectableGroup(),
            horizontalArrangement = Arrangement.spacedBy(NavigationBarItemHorizontalPadding, Alignment.CenterHorizontally),
            verticalAlignment = Alignment.CenterVertically
        ) {

            Box(
                contentAlignment = Alignment.Center,
                modifier = Modifier.weight(1f).nonReplyClick {
